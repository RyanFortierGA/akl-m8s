    ...
    <div class="mx-auto max-w-5xl space-y-8 p-6">
        <div class="flex items-end justify-between gap-4">
            <div>
                ...
                <p class="text-muted-foreground">Create nights, attach Stripe products, watch signups and waitlists.</p>
            </div>
            <Button as-child>
        ...
        <div class="grid gap-4 sm:grid-cols-4">
            <div class="rounded-2xl border bg-card p-4">
                <div class="text-sm text-muted-foreground">Upcoming nights</div>
                ...
                >
                    <div>
                        ...
                        <div class="text-sm text-muted-foreground">
                            {{ event.starts_at_label }} · {{ event.signups }} went · waitlist {{ event.waitlist }}
                        </div>
                    </div>
